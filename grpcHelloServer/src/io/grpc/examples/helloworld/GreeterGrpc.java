...
public final class GreeterGrpc {
  ...
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<ByeRequest,
      ByeReply> METHOD_SAY_BYE =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "helloworld.Greeter", "SayBye"),
          io.grpc.protobuf.ProtoUtils.marshaller(ByeRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(ByeReply.getDefaultInstance()));
  ...
  public static abstract class GreeterImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayBye(ByeRequest request,
        io.grpc.stub.StreamObserver<ByeReply> responseObserver) {
  ...
  public static final class GreeterBlockingStub extends io.grpc.stub.AbstractStub<GreeterBlockingStub> {
    ...
    /**
     */
    public ByeReply sayBye(ByeRequest request) {
      return blockingUnaryCall(
  ...
  public static final class GreeterFutureStub extends io.grpc.stub.AbstractStub<GreeterFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ByeReply> sayBye(
        ByeRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_SAY_BYE:
          serviceImpl.sayBye((ByeRequest) request,
              (io.grpc.stub.StreamObserver<ByeReply>) responseObserver);
          break;
        default:
